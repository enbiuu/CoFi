...
class MAGNN_metapath_specific(nn.Module):
    ...
    def forward(self, inputs):
        ...
        edata = F.embedding(edge_metapath_indices.long(), features)
...
class MAGNN_lp(nn.Module):
    ...
    def forward(self, inputs):
        ...
        for i, adapter in enumerate(self.adapter_list):
            ...
            transformed_features[node_indices] = adapter(features_list[i])
        ...
        logits_user = F.normalize(logits_user, p=2, dim=-1)
